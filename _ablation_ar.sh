...
#SBATCH --job-name=yes_pretrained
#
...
python -m torch.distributed.launch \
    --nproc_per_node=2 --master-port 29501 finetune_xlnet_distributed.py \
    ...
    --output_dir /atlas/u/gabeguo/iclr2026_rebuttal/yes_pretrained \
