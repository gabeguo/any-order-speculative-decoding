...
#SBATCH --job-name=code_no_warmup_mask
#
...
python -m torch.distributed.launch \
    --nproc_per_node=2 finetune_xlnet_distributed.py \
    --batch_size 4 --accumulation_steps 4 \
    --learning_rate 1e-5 \
    --warmup_steps 5000 --masking_warmup_steps 1 \
    ...
    --output_dir /atlas/u/gabeguo/iclr2026_rebuttal/code_ablation/no_warmup_mask \
